    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cardUserKey', models.CharField(blank=True, max_length=255, null=True)),
                ('phone', models.CharField(default='08503070535', max_length=20, verbose_name='Phone')),
                ('card_user_key', models.CharField(blank=True, max_length=255, null=True)),
