...
class EntegraPagination(PageNumberPagination):
    page_size = 10
    page = 1
    max_page_size = 100000
    page_size_query_param = 'page_size'
...
class CustomElasticSearchPagination(pagination.PageNumberPagination):
    page_size = 10
    page = 1
    max_page_size = 1000000
    page_size_query_param = 'page_size'
...
class CustomElasticSearchPaginationForSearch(pagination.PageNumberPagination):
    page_size = 10
    page = 1
    max_page_size = 1000000
    page_size_query_param = 'page_size'
    ...
    def get_paginated_response(self, data, vendors=None, categories=None, brands=None, variants=None, specs=None):
        return Response({
            'next_page_url': self.get_next_link(),
            'prev_page_url': self.get_previous_link(),
            "first_page_url": self.get_first_link(),
